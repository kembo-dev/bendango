...
def _recent_successful_merchant_count(query: str, minutes: int | None = None) -> int:
    if not query:
        return 0
    minutes = max(1, int(minutes or getattr(settings, 'SCRAPE_COVERAGE_WINDOW_MINUTES', 30)))
